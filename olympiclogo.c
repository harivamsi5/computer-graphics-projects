...
{
s = (i + k) % numc + 0.5;
t = j % numt;x = cos(t * twopi / numt) * cos(s * twopi / numc);
y = sin(t * twopi / numt) * cos(s * twopi / numc);
z = sin(s * twopi / numc);glNormal3f(x, y, z);
...
glColor3f(1,1,1);
	...
	glColor3f(0.502f, 0.000f, 0.502f);
	char str8[]="NAME:HARI VAMSI KRISHNA";
        char str9[]="USN: 1KS16CS058";
...
int sub=glutCreateMenu(speed_menu);
