...
void display(void){
	...
	char str[]="K.S Institute of Technology";
	glRasterPos2f(350,950); //take midpoint of gluOrtho2D
	for(i=0;i<strlen(str);i++){
	glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,str[i]);		
	}
	glColor3f(0.502f, 0.000f, 0.502f);
	char str3[]="COMPUTER GRAPHICS AND VISUALIZATION";
	glRasterPos2f(290,800); //take midpoint of gluOrtho2D
	for(i=0;i<strlen(str3);i++){
	glutBitmapCharacter(GLUT_BITMAP_HELVETICA_18,str3[i]);		
	}
	glColor3f(0.502f, 0.000f, 0.502f);
	char str4[]="MINI PROJECT";
	glRasterPos2f(400,700); //take midpoint of gluOrtho2D
	...
	glColor3f(0.502f, 0.000f, 0.502f);
	char str8[]="NAME:HARSHITHA.G.R";
        char str9[]="USN: 1KS16CS024";
	glRasterPos2f(42,250); //calculate points by refering previous text positions
	for(i=0;i<strlen(str8);i++){ 
	glutBitmapCharacter(GLUT_BITMAP_HELVETICA_18,str8[i]);		
	}
glRasterPos2f(42,200);
...
void secondpage(void){                ////////////first stage of Human evolution
	...
	/////////////////////////////////////////////////////////
	glColor3f(0.000f, 0.000f, 0.545f);
	output(790,290,"Scientific classification");
	glColor3f(0.502f, 0.000f, 0.000f);
	output(810,265,"Kingdom : Animalia");
	output(810,235,"Phylum	: Chordata");
	output(810,205,"Class   : Mammalia");
	output(810,175,"Order   : Primates");
	output(810,145,"Family  : Hominidae");
	//////////////////////////////////////////////////////////
...
void fifthpage(void)				/////fourth stage of human evolution Homo habils
{
	...
	//////////////////////////////////
	glColor3f(0.000f, 0.000f, 0.545f);
	output(790,345,"Scientific classification");
	glColor3f(0.502f, 0.000f, 0.000f);
	output(810,320,"Kingdom : Animalia");
	output(810,290,"Phylum	: Chordata");
	output(810,260,"Class   : Mammalia");
	output(810,230,"Order   : Primates");
	output(810,200,"Family  : Hominidae");
	glFlush();
}
...
void eightpage(void)
{
	...
	glTranslatef(145,-100,0);
	glColor3f(0.000,0.000,0.000);
	output(20,260,"Ardipithecus");
	output(180,260,"Australopithecus");
	output(365,260,"Australo-africans");
