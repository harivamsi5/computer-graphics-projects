...
GLfloat lightOnePosition[] = {450, 100, 1500, 1};
GLfloat lightOneColor[] = {1.0, 0.5, 0, 1.0};

GLfloat lightTwoDirection[] = {0, 0.05, -1};
GLfloat lightTwoPosition[] = {900, 100, 1500, 1};
GLfloat lightTwoColor[] = {1.0, 0.0, 1, 1.0};

GLfloat lightZeroPosition[] = {400, 200, 300, 1};
GLfloat lightZeroColor[] = {.3, .3, .3, .3};

GLfloat diskColor[] = {1.0, 0.5, 0.5, .1}, poleColor[] = {0.5, 0.5, 0.5, 1.0};
